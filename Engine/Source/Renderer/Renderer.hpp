...
namespace aio
{
	...
	public:
		...
		static void DrawTriangle(const Vector2& p1, const Vector2& p2, const Vector2& p3, const Vector4& color = Vector4(1.0f), bool isFilled = true);
		static void DrawQuad(const Vector2& position, const Vector2& size, const Vector4& color = Vector4(1.0f), bool isFilled = true);
